class Level1Scene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(70, 50, 'level1sign').setScale(0.35);
    ...
    this.platforms.create(330, 450, 'platform').setScale(0.22, 0.3).refreshBody();
    this.platforms.create(540, 400, 'platform').setScale(0.20, 0.3).refreshBody();
    this.platforms.create(850, 300, 'platform').setScale(0.3, 0.3).refreshBody();
    ...
    this.ground.create(0, 640, 'ground').setOrigin(0, 1).setScale(0.2, 0.3).refreshBody();
    this.ground.create(720, 640, 'ground').setOrigin(0, 1).setScale(0.25, 0.40).refreshBody();
    this.ground.create(525, 640, 'ground').setOrigin(0, 1).setScale(0.25, 0.25).refreshBody();
    ...
    this.coins.create(290, 380, 'coin').setScale(0.35, 0.35).refreshBody();
    this.coins.create(350, 290, 'coin').setScale(0.35, 0.35).refreshBody();
    this.coins.create(560, 320, 'coin').setScale(0.35, 0.35).refreshBody();
    this.coins.create(780, 450, 'coin').setScale(0.35, 0.35).refreshBody();
    this.coins.create(830, 450, 'coin').setScale(0.35, 0.35).refreshBody();
    ...
    this.star = this.physics.add.sprite(855, 220, 'star').setScale(0.14, 0.14).refreshBody();
    ...
    const danger1 = this.dangers.create(350, 398, 'danger').setScale(0.25, 0.25);
    danger1.refreshBody();
    ...
    const danger2 = this.dangers.create(600, 510, 'danger').setScale(0.3, 0.3);
    danger2.refreshBody();
    ...
    const danger3 = this.dangers.create(680, 517, 'danger').setScale(0.25, 0.25);
    danger3.refreshBody();
  ...
  collectStar(player, star) {
    ...
    this.sound.play('starSound', { volume: 0.2 });
